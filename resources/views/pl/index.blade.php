    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Profil Lulusan</h1>
        ...
        <div class="block block-rounded block-fx-shadow">
            <div class="block-header block-header-default">
                ...
                <div class="block-options">
                    <a href="{{ route('tambahpl') }}" class="btn btn-sm btn-primary">Tambah</a>
                </div>
            </div>
                        ...
                        @foreach($pl as $item)
                            <tr>
                                ...
                                <td class="text-center" style="width: 100px">
                                    <div class="btn-group">
                                        <a type="button" href="{{ Request::url() }}/edit/{{ $item->id }}"
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm edit"
                                                title="Delete"
                                                onclick="deleteConfirm('{{ Request::url() }}/hapus/{{ $item->id }}')">
