...
@section('content')
    ...
    <div class="content">
        ...
        <div class="col-md-6 " style="float:none;margin:auto;">
            <form method="POST" action="{{ route('form-tambah-pl') }}">
                    ...
                    <div class="block-content">
                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-lg-10 col-lg-8">
                                <div class="mb-4">
                                    <label class="form-label" for="kode_pl">Kode pl</label>
                                    <input type="text" class="form-control" id="kode_pl" name="kode_pl"
                                           placeholder="Masukkan Kode pl..." required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="deskripsi">Nama pl</label>
                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi"
                                           placeholder="Masukkan deskripsi pl..." required>
                                </div>
                            </div>
                        </div>
                    </div>
